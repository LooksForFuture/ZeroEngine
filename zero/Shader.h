...
public:
    ...
    Shader(char* vertexCode, char* fragmentCode) {
        const char* vShaderCode = vertexCode;
        const char* fShaderCode = fragmentCode;
        // 2. compile shaders
        unsigned int vertex, fragment;
    ...
    //setup for non used constructor
    void setup(std::string vertexCode, std::string fragmentCode) {
        const char* vShaderCode = vertexCode.c_str();
        const char* fShaderCode = fragmentCode.c_str();
        // 2. compile shaders
        unsigned int vertex, fragment;
    ...
    void setup(char* vertexCode, char* fragmentCode) {
        const char* vShaderCode = vertexCode;
        const char* fShaderCode = fragmentCode;
        // 2. compile shaders
        unsigned int vertex, fragment;
